...
var file_pb_pb_proto_rawDesc = []byte{
	...
	0x28, 0x0d, 0x52, 0x03, 0x6c, 0x65, 0x6e, 0x42, 0x05, 0x5a, 0x03, 0x2f, 0x70, 0x62, 0x62, 0x06,
...
var file_pb_pb_proto_goTypes = []any{
	(*KV)(nil),          // 0: pb.KV
	(*KVList)(nil),      // 1: pb.KVList
	(*TableIndex)(nil),  // 2: pb.TableIndex
	(*BlockOffset)(nil), // 3: pb.BlockOffset
}
var file_pb_pb_proto_depIdxs = []int32{
	0, // 0: pb.KVList.kvs:type_name -> pb.KV
	3, // 1: pb.TableIndex.offsets:type_name -> pb.BlockOffset
